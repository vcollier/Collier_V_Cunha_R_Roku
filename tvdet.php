...
<body>
    <div class="det-con">
    <?php if (!is_string($getTv)): ?>
        <?php while ($row = $getTv->fetch(PDO::FETCH_ASSOC)): ?>
            <video  id="movie-1" src="video/<?php echo $row['tv_trailer']; ?>" controls autoplay></video>
            <h2><?php echo $row['tv_title']; ?></h2>
            <h4><?php echo $row['tv_year']; ?></h4>
            <p><br> <?php echo $row['tv_storyline']; ?></p>
